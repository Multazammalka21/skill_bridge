    ...
    <form action="{{ route('admin.lessons.update', $lesson) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card" style="margin-bottom:20px;">
            <div class="card__header">
                ...
                <span style="font-size:0.78rem; color:var(--text-muted);">ID #{{ $lesson->id }}</span>
            </div>
            <div class="card__body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" class="form-textarea" rows="3" maxlength="1000">{{ old('deskripsi', $lesson->deskripsi) }}</textarea>
                </div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                    <div class="form-group">
                        ...
                        <input type="number" name="urutan" class="form-input" value="{{ old('urutan', $lesson->urutan) }}" min="0" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Durasi (Menit) <span style="color:var(--red);">*</span></label>
                        <input type="number" name="durasi_menit" class="form-input" value="{{ old('durasi_menit', $lesson->durasi_menit) }}" min="1" max="120" required>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card__body">
                <div class="form-group">
                    ...
                    <div style="display:grid; grid-template-columns:repeat(5,1fr); gap:10px; margin-top:4px;">
                        ...
                        <label style="border:2px solid {{ old('konten_tipe', $lesson->konten_tipe) == $val ? 'var(--teal)' : 'var(--border)' }};
                ...
                <div class="form-group">
                    ...
                    <textarea name="teks_narasi" class="form-textarea" rows="4">{{ old('teks_narasi', $lesson->teks_narasi) }}</textarea>
                </div>

                <div class="form-group">
                    <label class="form-label">📄 Teks Keterangan</label>
                    <textarea name="teks_keterangan" class="form-textarea" rows="3">{{ old('teks_keterangan', $lesson->teks_keterangan) }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="card__body">
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
                    ...
                    <div class="form-group">
                        ...
                        @if($lesson->gambar)
                            <div style="margin-bottom:10px; padding:10px; background:#f8fafc; border-radius:8px; border:1px solid var(--border);">
                                <img src="{{ asset($lesson->gambar) }}" style="max-height:80px; border-radius:6px; max-width:100%; display:block; margin-bottom:8px;">
                                <label style="display:flex; align-items:center; gap:6px; font-size:0.78rem; cursor:pointer; color:var(--red);">
                        ...
                        <div style="font-size:0.72rem; color:var(--text-muted); margin-top:4px;">JPG, PNG, WebP • Maks 3MB. Kosongkan jika tidak ganti.</div>
                    ...
                    <div class="form-group">
                        ...
                        @endif
                        <input type="file" name="efek_suara_file" class="form-input" accept=".mp3,.wav,.ogg,.m4a"
                               style="padding:6px; font-size:0.85rem;">
                        <div style="font-size:0.72rem; color:var(--text-muted); margin-top:4px;">MP3, WAV, OGG • Maks 10MB. Kosongkan jika tidak ganti.</div>
                    </div>
                </div>
        ...
        <div class="card" style="margin-bottom:24px;">
            <div class="card__header"><h3 class="card__title">⚙️ Pengaturan</h3></div>
            <div class="card__body">
        ...
        <div style="display:flex; gap:12px;">
            <button type="submit" class="btn btn--primary" style="padding:10px 28px;">💾 Simpan Perubahan</button>
