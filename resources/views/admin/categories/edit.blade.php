...
<div style="max-width:680px;">
    ...
    <div class="admin-card">
        <div class="admin-card__header">
            ...
            <div style="display:flex; align-items:center; gap:10px;">
                <span style="font-size:0.8rem; color:var(--admin-text-muted);">ID #{{ $category->id }}</span>
                @if($category->aktif)
        ...
        <div class="admin-card__body">
            <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                ...
                <div class="admin-form-group">
                    ...
                    <input type="text" name="nama" class="admin-form-input"
                ...
                <div class="admin-form-group">
                    ...
                    <textarea name="deskripsi" class="admin-form-textarea" maxlength="500">{{ old('deskripsi', $category->deskripsi) }}</textarea>
                </div>

                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                    <div class="admin-form-group">
                        <label class="admin-form-label">Ikon (Emoji) <span style="color:var(--admin-danger);">*</span></label>
                        <input type="text" name="ikon" class="admin-form-input"
                ...
                <div class="admin-form-group">
                    ...
                    <input type="number" name="urutan" class="admin-form-input"
    ...
    <div class="admin-card" style="margin-top:20px; border-color:rgba(239,68,68,0.2);">
        <div class="admin-card__header" style="background:rgba(239,68,68,0.03);">
            <h3 class="admin-card__title" style="color:var(--admin-danger);">⚠️ Zona Berbahaya</h3>
        </div>
        <div class="admin-card__body">
            <p style="font-size:0.85rem; color:var(--admin-text-secondary); margin-bottom:16px;">
            ...
            <form action="{{ route('admin.categories.destroy', $category) }}" method="POST"
                ...
                @csrf
                @method('DELETE')
                <button type="submit" class="admin-btn admin-btn--danger">🗑️ Hapus Kategori</button>
            </form>
        </div>
    </div>
    @endif
