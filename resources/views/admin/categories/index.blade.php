...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px;">
    <div>
        <h2 style="font-size:1.4rem; font-weight:800; color:var(--text-primary); margin-bottom:4px;">Kategori Pembelajaran</h2>
        <p style="color:var(--text-muted); font-size:0.85rem;">Kelola kategori materi seperti Literasi, Numerasi, Pengenalan Lingkungan, dll.</p>
    </div>
...
<div class="card">
    <div class="card__header">
        <h3 class="card__title">🗂️ Daftar Kategori</h3>
        <span style="font-size:0.82rem; color:var(--text-muted);">{{ $categories->count() }} kategori</span>
    </div>
        ...
        @else
            <table class="admin-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align:center; font-weight:700; color:var(--text-muted);">{{ $category->urutan }}</td>
                        <td>
                            <div style="display:flex; align-items:center; gap:12px;">
                                ...
                                <div>
                                    <div style="font-weight:700; color:var(--text-primary);">{{ $category->nama }}</div>
                        ...
                        <td>
                            <span style="font-weight:700; font-size:1.1rem; color:var(--text-primary);">{{ $category->lessons_count }}</span>
                            <span style="font-size:0.78rem; color:var(--text-muted); margin-left:4px;">materi</span>
                        </td>
                        <td>
                            @if($category->aktif)
                        ...
                        <td>
                            <div style="display:flex; gap:6px;">
                                <a href="{{ route('admin.categories.edit', $category) }}" class="btn btn--neutral btn--sm">✏️ Edit</a>
